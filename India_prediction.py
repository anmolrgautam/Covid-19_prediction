# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 22:13:21 2020
...
# make a new dataframe of India country
df = data[["India"]]
...
Augmented_Dickey_Fuller_Test_func(df['India'],['India'])

# Split data in train and test
X = df[['India']]
train, test = X[0:216], X[215:]
...
forecast = pd.DataFrame(forecast, columns=['India_pred'])
...
plt.title('India_RMSE: %.4f'% np.sqrt(metrics.mean_squared_error(test, forecast[0:30])))
plt.legend(loc='best')
